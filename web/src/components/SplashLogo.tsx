    ...
    >
      ...
      <div className="relative grid place-items-center">
        ...
        <div
          ...
          style={{ animation: "minerva-glow 2.4s ease-in-out" }}
        />
        ...
        <div
          ...
          style={{ animation: "minerva-word .55s cubic-bezier(.4,0,.2,1) 1.25s both" }}
        >
          Minerva
        </div>
        <div
          className="mt-1 font-mono text-[10.5px] uppercase tracking-[0.16em] text-muted-foreground"
          style={{ animation: "minerva-word .55s cubic-bezier(.4,0,.2,1) 1.45s both" }}
        >
